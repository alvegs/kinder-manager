...
void main() {
  ...
  group('ID validation tests', () {
    ...
    test('check valid id', () {
      final validator = ValidIdValidator();
      expect(validator.isValid('100000'), true);
    });
  ...
  /// -------------------------------------     Image File VALIDATOR TESTS IS BELOW THIS LINE ------------------
  group('ImageFile validation tests', () {
    /// POSITIVE TEST
    test('test image file long string', () {
      final validator = ValidImageFileValidator();
      expect(validator.isValid('http://test.test.com/test.png'), true);
    });
    ...
    test('test image file long string', () {
      ...
      expect(
          validator
              .isValid('http://test.test.com/test/test/test/test/test.png'),
          true);
    });

    /// POSITIVE TEST
    test('test image file valid string', () {
      final validator = ValidImageFileValidator();
      expect(validator.isValid('http://test.test.com/test.png'), true);
    });

    /// NEGATIVE TEST
    test('test image file too short string', () {
      final validator = ValidImageFileValidator();
      expect(validator.isValid('http://test.png'), false);
    });
  });
}
